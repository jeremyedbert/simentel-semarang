        ...
        <div class="container">
            ...
            <form method="POST" action="/user/riwayat/{{ $data->id }}/update" enctype="multipart/form-data">
                ...
                <div class="col mb-5">
                    ...
                    <div class="form-group">
                        <label class="form-label">Lampiran/Dokumen Pendukung <span style="color: #e12454"><b> * </b></span></label>
                        
                        <div class="form-document d-flex align-items-center @error('document') is-invalid @enderror">
                        ...
                        <small>Jenis file: PDF, ukuran maksimal: 10 MB</small>
